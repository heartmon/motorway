...
map.setCenter(new OpenLayers.LonLat(lon, lat).transform(new OpenLayers.Projection("EPSG:4326"), map.getProjectionObject()), 13);
...
function selectMapPoint(index) {
    ...
    selectController.select(map.layers[4].features[index]);
}